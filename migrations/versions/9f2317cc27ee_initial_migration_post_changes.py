"""initial migration post changes

Revision ID: 9f2317cc27ee
Revises:
Create Date: 2025-07-25 16:14:27.538221
...
def upgrade():
    ...
    op.execute("SET search_path TO 'neondb'")  # Set schema context
    ...
    sa.ForeignKeyConstraint(['client_id'], ['clients.id'], ),
    sa.ForeignKeyConstraint(['workout_log_id'], ['workout_log.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
